...
//    @NotEmpty(message = "Không được để trống")
    ...
    @ManyToOne
    @JoinColumn(name = "id_clienttype")
    private ClientType clientType;

    public Client() {
    }

    public Client(Long id, String name, String dateOfBirth, String gender, String idNumber, String phoneNumber, String email, String address, ClientType clientType) {
        this.id = id;
        this.name = name;
